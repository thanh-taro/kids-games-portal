...
const FLAGS = [
  { flag: "🇻🇳", code: "vn", name: "Việt Nam" },
  { flag: "🇺🇸", code: "us", name: "Hoa Kỳ" },
  { flag: "🇬🇧", code: "gb", name: "Anh" },
  { flag: "🇫🇷", code: "fr", name: "Pháp" },
  { flag: "🇩🇪", code: "de", name: "Đức" },
  { flag: "🇮🇹", code: "it", name: "Ý" },
  { flag: "🇪🇸", code: "es", name: "Tây Ban Nha" },
  { flag: "🇵🇹", code: "pt", name: "Bồ Đào Nha" },
  { flag: "🇷🇺", code: "ru", name: "Nga" },
  { flag: "🇨🇳", code: "cn", name: "Trung Quốc" },
  { flag: "🇯🇵", code: "jp", name: "Nhật Bản" },
  { flag: "🇰🇷", code: "kr", name: "Hàn Quốc" },
  { flag: "🇰🇵", code: "kp", name: "Triều Tiên" },
  { flag: "🇮🇳", code: "in", name: "Ấn Độ" },
  { flag: "🇹🇭", code: "th", name: "Thái Lan" },
  { flag: "🇱🇦", code: "la", name: "Lào" },
  { flag: "🇰🇭", code: "kh", name: "Campuchia" },
  ...
  { flag: "🇹🇱", code: "tl", name: "Đông Timor" },
  { flag: "🇦🇺", code: "au", name: "Úc" },
  ...
  { flag: "🇪🇬", code: "eg", name: "Ai Cập" },
  { flag: "🇿🇦", code: "za", name: "Nam Phi" },
  { flag: "🇳🇬", code: "ng", name: "Nigeria" },
  { flag: "🇰🇪", code: "ke", name: "Kenya" },
  { flag: "🇲🇦", code: "ma", name: "Morocco" },
  { flag: "🇹🇷", code: "tr", name: "Thổ Nhĩ Kỳ" },
  { flag: "🇬🇷", code: "gr", name: "Hy Lạp" },
  { flag: "🇳🇱", code: "nl", name: "Hà Lan" },
  { flag: "🇧🇪", code: "be", name: "Bỉ" },
  { flag: "🇨🇭", code: "ch", name: "Thụy Sĩ" },
  { flag: "🇦🇹", code: "at", name: "Áo" },
  { flag: "🇸🇪", code: "se", name: "Thụy Điển" },
  { flag: "🇳🇴", code: "no", name: "Na Uy" },
  { flag: "🇩🇰", code: "dk", name: "Đan Mạch" },
  { flag: "🇫🇮", code: "fi", name: "Phần Lan" },
  { flag: "🇵🇱", code: "pl", name: "Ba Lan" },
  { flag: "🇮🇪", code: "ie", name: "Ireland" },
  { flag: "🇮🇸", code: "is", name: "Iceland" },
  { flag: "🇺🇦", code: "ua", name: "Ukraine" },
  { flag: "🇨🇿", code: "cz", name: "Séc" },
  { flag: "🇭🇺", code: "hu", name: "Hungary" },
  { flag: "🇷🇴", code: "ro", name: "Romania" },
  { flag: "🇸🇦", code: "sa", name: "Ả Rập Xê Út" },
...
function genFlag(stage) {
  ...
  return {
    category: "flag",
    prompt: "Đây là quốc kỳ nước nào?",
    flagCode: item.code,
    choices: shuffle(Array.from(choices)),
    answer: item.name,
  };
